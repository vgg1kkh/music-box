      ...
      <RecommendBanner>
        <div className="content w980">
          <div className="banner-left">
            <div className="button-left text-indent" onClick={carouselRef.current.prev()}>Button Left</div>
            <div className="button-right text-indent" onClick={carouselRef.current.prev()}>Button right</div>
            <Carousel 
             ref={carouselRef}
            dots 
